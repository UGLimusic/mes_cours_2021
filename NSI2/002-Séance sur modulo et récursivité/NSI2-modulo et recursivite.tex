...
En \textsc{Python} on obtient \mintinline{python}{Q} en évaluant \mintinline{python}{A // B} et \mintinline{python}{R} en évaluant \mintinline{python}{A % B}, cette dernière opération se lit \og \mintinline{python}{A} modulo \mintinline{python}{B}\fg{}.
Voici un exemple
...
\begin{enumerate}[\bfseries 1.]
	\item 	En \textsc{Python}, écrire une fonction (non-récursive) \mintinline{python}{units_digit} qui
			\begin{enumerate}[--]
			...
			\end{enumerate}
	\item 	De même écrire une fonction (non-récursive) \mintinline{python}{hundreds_digit} pour le chiffre des centaines.
	\item 	De même pour une fonction (non-récursive) \mintinline{python}{thousands_digit} qui renvoie le chiffre des milliers.
\end{enumerate}
\end{exercice}
